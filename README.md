...
- **Multi-source scraping**: JAV.guru (async + Cloudflare bypass) and MissAV (category + code-based)
...
```bash
chmod +x run_pipeline.sh missav_pipeline.sh
...
- [ ] **Add onejav.com scraper** — New source for torrent/magnet link aggregation
